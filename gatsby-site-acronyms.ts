export default {
  ...
  MDX: 'Markdown JSX Component JavaScript expressions',
  MS: 'Microsoft',
  ...
  PR: 'Pull Request',
  PSYOPS: 'Operations that use information to influence the behavior of groups, governments, and foreign powers',
