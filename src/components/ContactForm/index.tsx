...
export default function ContactForm() {
  ...
  return (
    <div className="-pt-2 mb-24 max-w-[700px] text-slate-900 dark:text-slate-200 lg:col-span-2 lg:mt-0">
              ...
              <div className="px-4 py-5 text-slate-900 dark:text-slate-200 sm:p-6">
                <div className="-mx-3 mb-6 flex flex-wrap">
                  <div className="mb-6 w-full px-3 md:mb-0 md:w-1/2">
                    ...
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-gray-400 bg-gray-200 pl-3 pr-3 text-gray-900 dark:border-gray-800 dark:bg-gray-700 dark:text-gray-300">
                        <svg
                ...
                <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-gray-400 bg-gray-200 pl-3 pr-3 text-gray-900 dark:border-gray-800 dark:bg-gray-700 dark:text-gray-300">
                        <svg
                          ...
                          strokeWidth="1.5"
                          stroke="currentColor"
                          className="h-5 w-5 text-gray-500 opacity-70 dark:text-gray-300"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                  ...
                  <div className="col-span-6">
                    ...
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-gray-400 bg-gray-200 pl-3 pr-3 text-gray-900 opacity-70 dark:border-gray-800 dark:bg-gray-700 dark:text-gray-300">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
