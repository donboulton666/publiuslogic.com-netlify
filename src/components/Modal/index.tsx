    ...
    <>
      <div className="fixed left-1 top-1/4 z-10">
        <button
          type="button"
          onClick={openModal}
          className="-ml-1 h-auto w-auto rounded-r-md bg-slate-300 pb-0 pl-3 pr-2 pt-2 text-slate-900 dark:bg-slate-900 dark:text-slate-200"
        >
      ...
      <Transition appear show={isOpen} as={Fragment} {...rest}>
        ...
        >
          ...
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-slate-500 bg-opacity-75 transition-opacity dark:bg-slate-950" />
          </Transition.Child>
