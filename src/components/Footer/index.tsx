...
export default function Footer() {
  return (
    <>
      <footer className="relative w-full bg-slate-950 pb-6 pt-8">
                  ...
                  <ColumnGridTwo>
                    ...
                    <div className="mb-2 mr-2">
                      <span className="group relative flex items-center text-slate-300">
                        ...
                        <Link
                          to="https://www.youtube.com/watch?v=G7ceN1JqdUQ&list=PLC06D3D53BA50A744"
                          className="hover:text-wine-300"
                          rel="noopener noreferrer"
                          target="_blank"
                  ...
                  <ColumnGridTwo>
                    <div className="mr-2">
                      <span className="group relative flex items-center text-slate-300">
                        ...
                        <Link
                          to="https://www.facebook.com/profile.php?id=61555130111015"
                          className="hover:text-wine-300"
                          rel="noopener noreferrer"
                          target="_blank"
                    ...
                    <div className="mr-2">
                      <span className="group relative flex items-center text-slate-300">
                        ...
                        <Link
                          to="https://www.tiktok.com/@donboulton666"
                          className="hover:text-wine-300"
                          rel="noopener noreferrer"
                          target="_blank"
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <Link
                        ...
                        target="_blank"
                        area-label="Github"
                        to="https://github.com/donboulton666"
                      >
                        Github
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        to="https://github.com/donaldboulton/gatsby-starter-basic-instructions"
                      >
                        Free Starters
                      </Link>
                    </li>
