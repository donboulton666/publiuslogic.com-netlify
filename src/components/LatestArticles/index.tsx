...
export default function LatestArticles() {
  ...
  return (
    <>
      <Section>
        <div className="m-4 mx-auto max-w-7xl bg-slate-900 px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                      <div>
                        <Link
                          ...
                          className="mb-2 mt-4 text-xl font-semibold italic text-slate-300 underline hover:text-wine-200"
                        >
                          Creation Of All
                        </Link>
                        <div>
                    ...
                    <div>
                      <div>
                        <Link
                          id="virtue"
                          to="/blog/virtue"
                          className="mb-2 mt-4 text-xl font-semibold text-slate-300 underline hover:text-wine-200"
                        >
                          Virtue
                        </Link>
                        <div>
