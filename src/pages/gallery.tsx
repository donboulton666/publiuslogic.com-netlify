...
type ImageGalleryRef = React.ForwardedRef<HTMLDivElement>

function ImageGallery({ data }, props: ImageGalleryProps, ref: ImageGalleryRef) {
      ...
      <Layout>
        <PageTransition ref={ref}>
          <div className="left-beams">
            ...
            <div className="search-beams z-30 mb-32 mt-6">
    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          '@type': 'WebPage',
          name: 'Gallery',
          url: 'https://publiuslogic.com/gallery',
          image: {
            '@type': 'ImageObject',
            url: 'https://publiuslogic.com/static/images/undraw/undraw_Portfolio_re_qwm5.png',
            width: '1400',
            height: '450',
          },
          publisher: {
