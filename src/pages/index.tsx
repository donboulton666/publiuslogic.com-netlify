        ...
        <PageTransition ref={ref}>
          <div className="font-inter">
            <div className="relative flex content-center items-center justify-center">
              <div className="relative mb-4 h-96 w-full md:mb-0 md:h-60 lg:h-72">
                <StaticImage
                ...
                <LazyMotion features={loadFeatures}>
                  <motion.div
                    className="absolute left-3 top-16 z-30 p-4 font-sacramento text-2xl"
                    initial="hidden"
              ...
              <div className="pointer-events-none absolute bottom-0 left-0 right-0 top-auto mt-4 h-[70px] w-full overflow-hidden transition-all duration-200">
                <svg
                  ...
                  y="0"
                >
                  <polygon className="fill-current text-slate-950 opacity-90" points="2560 0 2560 100 0 100"></polygon>
                </svg>
              </div>
            </div>
            <section className="-mt-10 bg-slate-950 pb-10 text-slate-300 transition-all duration-200">
              <div className="container mx-auto px-4">
                <div className="flex flex-wrap">
                  <div className="w-full px-4 pt-4 text-center md:w-4/12 lg:pt-10">
                    <div className="relative mb-8 flex w-full min-w-0 flex-col break-words rounded-lg bg-wine-300 text-slate-200 shadow-lg shadow-wine-300/50 transition-all duration-200">
                      <div className="flex-auto px-4 py-5">
                        <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full bg-blue-700 p-3 text-center text-slate-200 shadow-lg shadow-blue-700/50">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                            ...
                            width="24px"
                            height="24px"
                            className="h-6 w-6 fill-slate-200 text-slate-200"
                          >
                            <path
                              strokeLinecap="round"
                        ...
                        <h6 className="text-xl font-semibold">
                          <Link to="/blog/commandments" area-label="Commandments" className="text-slate-300">
                            Planetary Laws
                          </Link>
                        </h6>
                  ...
                  <div className="w-full px-4 text-center md:w-4/12">
                    <div className="relative mb-8 flex w-full min-w-0 flex-col break-words rounded-lg bg-indigo-700 text-slate-200 shadow-lg shadow-indigo-700/50">
                      <div className="flex-auto px-4 py-4">
                        <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full bg-purple-500 p-3 text-center text-slate-200 shadow-lg shadow-purple-700/50">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                  ...
                  <div className="w-full px-4 pt-6 text-center md:w-4/12">
                    <div className="relative mb-8 flex w-full min-w-0 flex-col break-words rounded-lg bg-purple-600 text-slate-200 shadow-lg shadow-purple-600/50">
                      <div className="flex-auto px-4 py-5">
                        <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full bg-wine-300 p-3 text-center text-slate-200 shadow-lg shadow-wine-300/50">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                ...
                <div className="-mt-12 mb-10 text-slate-200 md:-mt-4">
                  ...
                  <div className="m-auto flex max-w-xs justify-center">
                    <div className="grid auto-cols-min grid-flow-col gap-4">
                      ...
                      <Link
                        ...
                        to="https://www.github.com/donaldboulton"
                        target="_blank"
                        rel="noreferrer"
                ...
                <div className="flex flex-wrap items-center bg-slate-900 text-slate-200">
                  <div className="mt-8 flex flex-wrap items-center">
                    <div className="mb-6 ml-auto mr-auto w-full px-4 md:w-5/12">
                      ...
                      <div className="first-letter:float-left first-letter:mr-3 first-letter:text-7xl first-letter:font-bold first-letter:text-slate-300 first-line:uppercase first-line:tracking-widest">
                  ...
                  <div className="pointer-events-none absolute bottom-0 left-0 right-0 top-auto mt-4 h-[70px] w-full overflow-hidden bg-slate-900 bg-transparent transition-all duration-200">
                    <svg
                      className="absolute bottom-0 overflow-hidden"
                      xmlns="http://www.w3.org/2000/svg"
                      preserveAspectRatio="none"
