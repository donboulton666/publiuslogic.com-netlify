...
type NotFoundPageRef = React.ForwardedRef<HTMLDivElement>

function NotFoundPage(props, ref: NotFoundPageRef) {
  return (
    <>
      <Layout>
          ...
          <div className="left-beams">
            ...
            <div className="mt-10">
              <div className="mb-16 mt-6 flex flex-col items-center">
                ...
                <div className="neon-div mb-16 mt-6 flex flex-col items-center">
                  <h1 className="neonText neon-h1 items-center text-2xl">page Not Found</h1>
                </div>
              </div>
            </div>
          </div>
    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          '@type': 'WebPage',
          name: '404 Not Found',
          url: 'https://publiuslogic.com/404',
          image: {
            '@type': 'ImageObject',
            url: 'https://publiuslogic.com/assets/404.jpg',
            width: '1400',
            height: '450',
          },
          publisher: {
