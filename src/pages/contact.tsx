    ...
    <>
      <Layout>
        <PageTransition ref={ref} key={refPage}>
          <div className="left-beams mb-10 overflow-x-hidden overscroll-contain">
            <PageHero
              title="Contact Us"
            ...
            <div className="form-beams mb-8">
              <Map />
              <div className="mb-10 mt-10 overflow-x-hidden p-8 text-slate-900 dark:text-slate-200 sm:mt-0">
                <div className="lg:grid lg:grid-cols-3 lg:gap-6">
                  <div className="lg:col-span-1">
                        ...
                        <ColumnGridTwo>
                          ...
                          <div className="mr-2">
                            <span className="group relative flex items-center text-slate-300">
                              ...
                              <Link
                                className="hover:text-wine-300"
                                to="https://youtube.com/c/donaldboulton"
                                rel="noopener noreferrer"
                                target="_blank"
                        ...
                        <ColumnGridTwo>
                          <div className="mr-2">
                            <span className="group relative flex items-center text-slate-300">
                              ...
                              <Link
                                to="https://www.youtube.com/@donboulton666"
                                className="hover:text-wine-300"
                                rel="noopener noreferrer"
                                target="_blank"
                          ...
                          <div className="mr-2">
                            <span className="group relative flex items-center text-slate-300">
                              ...
                              <Link
                                to="https://www.instagram.com/donboulton"
                                className="hover:text-wine-300"
                                rel="noopener noreferrer"
                                target="_blank"
                        ...
                        <ColumnGridTwo>
                          <div className="mr-2">
                            <span className="group relative flex items-center text-slate-300">
                              ...
                              <Link
                                to="https://www.facebook.com/donboulton"
                                className="hover:text-wine-300"
                                rel="noopener noreferrer"
                                target="_blank"
                          ...
                          <div className="mr-2">
                            <span className="group relative flex items-center text-slate-300">
                              ...
                              <Link
                                to="https://www.tiktok.com/@donaldboulton"
                                className="hover:text-wine-300"
                                rel="noopener noreferrer"
                                target="_blank"
                    ...
                    <div className="mb-4 mt-4">
                      <LeftText>
                        <Link to="https://donwboulton.com/contact" alt="Buy Me A Coffee">
                          {' '}
                          Donald{' '}
                    ...
                    <div className="mb-6 ml-12 mt-4 flex">
                      <Link to="https://www.buymeacoffee.com/donaldboulton/w/3913" alt="Buy Me A Coffee">
                        <StaticImage
