...
<GatsbyImage alt="Gatsby Version Five" imgclass="block object-cover object-center w-full h-full rounded-lg" image={getImage(props.localImages[0])} />

## Gatsby Version Five v5.13.4

This Site uses Gatsby Version `"gatsby": "^5.12.4"`, with React `18.3.1` Node `18.12.1` with NPM `8.11.0`.

Now I can use Gatsby 5.13.4, with MDX version 3.20.0
