...
Enoch, Abraham and Jesus are the way the truth and the light. Enoch and Abraham were coal Black. Jesus was a light skinned Black person, as all the [Essenes](https://en.wikipedia.org/wiki/Essenes) were.

<ImageColWrapperPage>

<GatsbyImage
  alt="Middle East 3500 BCE"
  imgclass="object-cover object-center w-full h-full rounded-lg"
...
<GatsbyImage
  alt="Dummy"
  imgclass="object-cover object-center w-24 h-24 rounded-lg"
...
<GatsbyImage
  alt="The Last Trustworthy News Broadcast"
  imgclass="object-cover object-center w-full h-full rounded-lg"
