...
<divGrid>
  <div>
    <span className="mb-1 ml-6 place-content-center text-center text-lg underline decoration-wine-200 decoration-wavy underline-offset-8 transition duration-300">
