...
Like our Bill of Rights and the Declaration of Independence basically was to be for all. ANd enforced as such!
...
It was never intended for everyone to be equal. The proofs of our past and subsequent laws furthering our rights with no codification to enforce the so called right. As example the Civil Rights Act (1964).
...
Just lies as they do not enforce what they wrote, as rights we were supposedly given.
