...
embeddedImagesLocal:
  ...
  - '../../../static/img/speed-test.jpg'
  - '../../../static/img/security-report.jpg'
  - '../../../static/img/site-driven1.png'
  - '../../../static/img/buy-me-a-coffee.jpg'
tags:
  - 'About'
  - 'Gatsby'
  - 'Starter'
...
I employ <HoverMenu title="Feynman">Feynman / Wisdom</HoverMenu> in explications of Code, Government, Law and God with a little Wisdom according to <HoverMenu title="Sufi">Sufi / Sufism Wisdom</HoverMenu> for kindness and brevity.
...
If you read them in order they have a timely purpose, <Popper tooltipText="Something you do not need!">playtime</Popper> is calling out the evil one's.
...
<GatsbyImage
  alt="Headers test Content-Security-Policy"
  imgclass="object-cover object-center w-full h-full rounded-lg"
...
with GraphQL, Built with WebPack.
...
- 🔏 Authentication (with Google Github / Redis / Supabase)
- 🔐 Authenticated Serverless Functions (Netlify Functions)
- 😻 External Provider login with GitHub, Google, etc.
- 🏠 Protected Routes Locked by Supabase Auth
...
<GatsbyImage
  alt="Buy Me A Coffee"
  imgclass="object-cover w-{240px} h-{76px} pt-2 mt-2 object-center rounded-lg text-center"
