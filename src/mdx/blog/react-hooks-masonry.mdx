...
path: /blog/react-hooks-masonry
date: 2019-03-25
category: Tech
tags: [React, Masonry, Hooks]
publicId: videos/angelina_jordan_suspicious_minds
embeddedImagesLocal:
  - '../../../static/assets/about.jpg'
videoTitle: Angelina Jordan Suspicious Minds
description: Now that we have React Hooks, so many components can be rewritten in a more succinct, readable and maintainable manner.
---
...
```jsx:title=src/components/masonry.jsx {21-27}
...
```jsx:title=src/hooks/useEventListener.jsx {15-26}
...
```jsx:title=src/styled/styled.jsx {17-26,32,33,49-52}
...
```jsx:title=src/components/masonry.jsx {3,11,24}
...
```jsx:title=src/components/colorbox.jsx {20-30,32,33,49-52}
