...
embeddedImagesLocal:
  - '../../../static/img/trinity-page.png'
  - '../../../static/img/trinity-math.png'
description: Life is comprised of 95% Dark Matter and 5% Matter. Which should you seek? The lesser fleshly life or your spiritual existence with a connection to the Trinity. Or Both being 100%!
---

import { getImage, GatsbyImage } from 'gatsby-plugin-image'

<Center>Trinary Composition</Center>
...
<GatsbyImage alt="A Trinity Subset in All Colors" image={getImage(props.localImages[0])} />
...
<GatsbyImage
  alt="A Trinity in All Substance"
  imgclass="object-cover object-center w-full h-full rounded-lg"
...
>
> > Your connection to the Trinity is individual, it does not have any thing to do with a group or a church, religion, a preacher, any of mans books, Tom down the street or the next door neighbor Sally. It's between you and Father God, Jesus and now Me!
...
You were created to do things for yourselves and to help others. We cannot live your lives for you! What would be your
purpose? But we can open, "You to YOU", if your heart is true!
...
Life, and have the power to erase what ever I want to; then, "what ever"; "Never Existed"!
