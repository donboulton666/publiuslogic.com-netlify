...
category: Logic
embeddedImagesLocal:
  - '../../../static/assets/earths-magnetic-flux.jpg'
tags:
  - 'Earth'
  - Magnetic Flux'
  - 'Oil'
description: Earths Magnetic Flux and Common Sense on Planetary Issues
videoUrl: https://www.youtube.com/watch?v=HEj4p8Ax3b4
videoTitle: Magnetic Flux
videoPoster: https://www.youtube.com/watch?v=HEj4p8Ax3b4
---

import { getImage, GatsbyImage } from 'gatsby-plugin-image'

<GatsbyImage alt="Earths Magnetic Crust" image={getImage(props.localImages[0])} />
...
<LeftText>Earth's magnetic field area appears to be splitting in half</LeftText>
<ColumnGridTwo>
<UserProfile buttonLink="https://www.youtube.com/watch?v=HEj4p8Ax3b4" title="861K subscribers" titleLink="https://www.youtube.com/@CTVNews" link="https://www.youtube.com/watch?v=HEj4p8Ax3b4" description="CTV News">

![CTV News](../../../static/img/ctv-news.jpg)
