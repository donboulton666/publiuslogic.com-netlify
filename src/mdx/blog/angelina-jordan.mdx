...
Get called by first name at restaurants and various places. And the looks! I guess I need to make videos and say something, now that there is no hiding! Just playing! It's almost time to kick the shit out of History, Governments and Regions including borders, everything based on culture and the peoples ways.

I don't remember you singing Imagine by the Beatles, please do so! I'll use it a background with attribute's to you on my Imagine works of God first!
