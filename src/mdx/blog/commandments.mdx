...
embeddedImagesLocal:
  - '../../../static/assets/commandments.png'
...
<GatsbyImage alt="Law" image={getImage(props.localImages[0])} />
...
Ye shall be responsible for all thing's in your life and interrelated through your acts, for what you do is of you, AND NO-ONE ELSE.
